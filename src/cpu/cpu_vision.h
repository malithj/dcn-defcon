#ifndef __CPU_VISION_H__
#define __CPU_VISION_H__

#include <torch/extension.h>

at::Tensor dcn_v3_cpu_forward(const at::Tensor &input, const at::Tensor &weight,
...
std::vector<at::Tensor> dcn_v3_cpu_backward(
    const at::Tensor &input, const at::Tensor &weight, const at::Tensor &bias,
    const at::Tensor &offset, const at::Tensor &mask,
    const at::Tensor &grad_output, int kernel_h, int kernel_w, int stride_h,
